...
frontend/
  src/
    ...
    pages/                  PortfoliosPage, HoldingsPage, TransactionsPage, ResearchPage (/research/:symbol — officially called "Explore page"; explore any stock; Quick Stats + Deep Research + Notes; reuses ReportTab + AnalysisTab; overview card from quickStats with company_name/sector/1Y return/5Y CAGR; max-w-xl mx-auto; no portfolio data dependency)
