...
| 2026-05-27 | Market Cap section in Allocation sub-tab | Second collapsible section below By Sector; buckets: Large Cap / Mid Cap / Small Cap / US Stocks / ETF-MF; sectors.ts extended with MarketCapKey, MARKET_CAP_COLOR, SYMBOL_MARKET_CAP (all 63 symbols), getMarketCapForHolding(); same column layout as sector section |
