            ...
            <div className="relative">
              ...
              {brokerPickerOpen && (
                <>
                  ...
                  {/* Inline, not absolute-positioned overlay — a short modal (few brokers) has no
                      192px of room above or below the button either way, so an overlay dropdown
                      would still spill past the modal's edge no matter which direction it opened.
                      Rendering it in normal flow instead just grows the modal's own scrollable
                      body, which can never fail to contain it. */}
                  <div className="relative z-[206] mt-1 bg-white border border-emerald-200 rounded-lg shadow-lg max-h-48 overflow-y-auto">
