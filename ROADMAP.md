...
| # | Item | Notes | Status |
|---|------|-------|--------|
| 1 | Dummy data / demo mode | Add a sanitized demo dataset so the app can be shown to others without exposing real portfolio; toggle between real and demo mode; demo data should cover Indian stocks, US stocks, and MFs across multiple portfolios | pending |
...
| Item | Completed |
|------|-----------|
| Demo mode — VITE_DEMO_MODE=true env var; usePortfolio hook returns static frontend/src/demo/portfolio.json (12 holdings: SBIN/DIVISLAB/INFY/HDFCBANK/BAJFINANCE/APOLLOHOSP/2 MFs/AAPL/AMZN/MSFT/GOOGL; broker names Zerodha/AngelOne/MF_Groww/Vested/IndMoney US; ~₹40L total); charts/research/benchmarking still call real backend for public market data; deploy as second Vercel project with env var set | 2026-06-05 |
