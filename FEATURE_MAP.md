...
| **Price fetching / cache** | — | `src/price_fetcher.py`, `src/cache.py`, `backend/price_refresh.py` (background 2-min warm-up loop, added 2026-07-02) |
